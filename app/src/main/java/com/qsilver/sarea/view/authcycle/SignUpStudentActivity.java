...
public class SignUpStudentActivity extends AppCompatActivity {
    ...
    private TextInputLayout email, name, civil_number, fatherPhone, matherPhone, level, password, userAddress, schoolIdTi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userImage = findViewById(R.id.auth_signUpStudent_logo);
        email = findViewById(R.id.signUpStudent_out_et_email);
        name = findViewById(R.id.signUpStudent_out_et_name);
        schoolIdTi = findViewById(R.id.SignupStudent_school_id_out);
        civil_number = findViewById(R.id.signUpStudent_out_et_civil_number);
        fatherPhone = findViewById(R.id.signUpStudent_out_et_father_phone);
        matherPhone = findViewById(R.id.signUpStudent_out_et_mather_phone);
        level = findViewById(R.id.signUpStudent_out_et_level);
        password = findViewById(R.id.signUpStudent_out_et_password);
        userAddress = findViewById(R.id.signUpStudent_out_et_adress);
        progressBar = findViewById(R.id.progressbar);
        doSignUpBtn = findViewById(R.id.signUpStudent_btn_signUp);
        goSignIn = (LinearLayout) findViewById(R.id.Student_tv_signIn);
        ...
        myUserType = LoadData(SignUpStudentActivity.this, "USER_TYPE");
    ...
    private void checkValidationStudent() {
        ...
        String getMatherPhone = matherPhone.getEditText().getText().toString();
        String getFatherPhone = fatherPhone.getEditText().getText().toString();
        ...
        if (getEmail.equals("") || getEmail.length() == 0 ||
            ...
            Toast.makeText(SignUpStudentActivity.this, "من فضلك إملئ جميع الحقول", Toast.LENGTH_LONG).show();
        } else if (!m.matches()) {
            Toast.makeText(SignUpStudentActivity.this, "من فضلك أدخل بريد إلكترونى صحيح", Toast.LENGTH_LONG).show();

        } else if (!isNetworkAvailable(SignUpStudentActivity.this)) {
            Toast.makeText(SignUpStudentActivity.this, "من فضلك تأكد من الإتصال بالإنترنت", Toast.LENGTH_LONG).show();
        }
        //TODO
...
//        }
            ...
            doSignUp(getEmail, getPassword, getName, getAddress, getCivilNumber, getSchoolId, getFatherPhone, getMatherPhone, getLevel);
            Toast.makeText(SignUpStudentActivity.this, "من فضلك إنتظر للتأكد من صحة البيانات", Toast.LENGTH_LONG).show();
    ...
    private void doSignUp(String email, String password, String name, String address,
                          String civilNumber, String schoolId, String fatherPhone, String matherPhone, String level)  {
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        SaveData(SignUpStudentActivity.this,"CURRENT_USER_ID",userId);

                        if (task.isSuccessful()) {
                            // save in users root
                            reference = FirebaseDatabase.getInstance().getReference("Users").child(userId);
                            User user = new User(email, civilNumber, matherPhone, fatherPhone,
                                    level, name, address, userId, myUserType,
                            ...
                            reference.setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Intent goToMainActivity = new Intent(SignUpStudentActivity.this, MainActivity.class);
                                        goToMainActivity.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                                        startActivity(goToMainActivity);
                                        overridePendingTransition(R.anim.left_enter, R.anim.right_out);
                                        Toast.makeText(SignUpStudentActivity.this, "تم تسجيل الدخول", Toast.LENGTH_LONG).show();
                                    }
